...
<head>
    ...
    <title>Dokumen Siap Dikirimkan</title>
    <style>
        body {
        ...
        <div class="content">
            ...
            <div class="notification-card">
                <div class="notification-title">
                    Semua Pihak Telah Menandatangani Dokumen
                </div>
                <p style="margin: 0; color: #555;">
                    Seluruh pihak telah menandatangani dokumen <strong>{{ $documentTypeLabel }}</strong>. Dokumen kini
                    siap untuk dikirimkan ke para pihak dan kasus dapat diselesaikan.
                </p>
            </div>
            ...
            <p style="margin-top: 30px; color: #555;">
                Terima kasih atas kerja sama Anda sebagai mediator dalam proses penyelesaian kasus ini.
            </p>
        </div>
        <!-- Footer -->
        <div class="footer">
