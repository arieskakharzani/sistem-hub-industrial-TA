...
<body>
    <div class="email-container">
        <div class="header">
            <h1>Anjuran Mediator</h1>
            <p>Sistem Informasi Pengaduan & Penyelesaian Perselisihan Hubungan Industrial</p>
        </div>

        <div class="content">
            <div class="greeting">
                Yth. {{ $user->name ?? 'Para Pihak' }},
            </div>

            <div class="notification-card">
                <div class="notification-title">
                    Anjuran Mediator Telah Diterbitkan
                </div>
                <p>Mediator telah menerbitkan anjuran untuk perselisihan Anda. Silakan review dan berikan jawaban Anda
                    dalam
                    waktu yang ditentukan. Jika tidak ada respon dalam jangka waktu yang ditentukan, maka Anda dianggap
                    menolak Anjuran.</p>
            </div>
            ...
            <div class="detail-grid">
                ...
                <div class="detail-item">
                    ...
                    <div class="detail-value">{{ $anjuran->published_at->format('d/m/Y H:i') }}</div>
                </div>
                <div class="detail-item">
            ...
            <div class="deadline-box">
                <h4 style="margin: 0 0 10px 0; color: #d97706; font-weight: 600;">⏰ Deadline Response:</h4>
                <p style="margin: 0; color: #333;">
                    <strong>{{ $deadline }}</strong><br>
                    Anda memiliki waktu <strong>{{ $anjuran->getDaysUntilDeadline() }} hari</strong> untuk memberikan
                    response.
                </p>
            </div>
