                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-3">
                            @if (auth()->user()->active_role === 'mediator' && $anjuran->status_approval === 'draft')
                                <form action="{{ route('dokumen.anjuran.submit', $anjuran->anjuran_id) }}"
                            ...
                            @if (auth()->user()->active_role === 'mediator' &&
                                ...
                                <div class="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                    <h4 class="font-semibold text-blue-900 mb-3">Aksi Berdasarkan Respon Para Pihak
                                    </h4>

                                    @if ($anjuran->isBothPartiesAgree())
                                        <!-- Jika kedua pihak setuju -->
                                        <div class="space-y-3">
                                            <p class="text-blue-800">Kedua pihak telah menyetujui anjuran. Anda dapat:
                                            </p>
                ...
                <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg">
                    <div class="relative">
                        ...
                        <div class="p-6 text-gray-900">
                            ...
                            <div class="mb-8">
                                <h3 class="font-semibold text-lg mb-4 text-gray-800">B. Keterangan pihak Pengusaha:
                                </h3>
                                <div class="bg-gray-50 p-6 rounded-lg whitespace-pre-line text-gray-700">
                            ...
                            @if ($anjuran->status_approval === 'approved' || $anjuran->status_approval === 'published')
                                <div class="mb-8 bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                                    ...
                                    <div class="text-yellow-700">
                                        ...
                                        @if ($anjuran->notes_kepala_dinas)
                                            <p class="mb-2">
                                                <strong>Catatan Kepala Dinas:</strong>
                                                {{ $anjuran->notes_kepala_dinas }}
                                            </p>
                                        @endif
                                    </div>
                                </div>
