                ...
                <div class="p-6 text-gray-900">
                            ...
                            <table class="min-w-full bg-white border border-gray-200 rounded-lg overflow-hidden">
                                <thead class="bg-gray-100">
                                    <tr>
                                        ...
                                        <th class="px-4 py-2 text-left text-sm font-semibold text-gray-700">Pengusaha
                                        </th>
                                        <th class="px-4 py-2 text-left text-sm font-semibold text-gray-700">Pekerja</th>
                                        <th class="px-4 py-2 text-left text-sm font-semibold text-gray-700">Isi Anjuran
                                        </th>
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <p class="text-gray-600">Semua anjuran telah diproses atau belum ada anjuran yang disubmit
                                untuk approval.</p>
                        </div>
                    @endif
                </div>
