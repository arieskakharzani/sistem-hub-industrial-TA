...
<head>
    ...
    <title>Buat Perjanjian Bersama</title>
        ...
        <div class="max-w-6xl mx-auto px-5 py-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-8 py-6 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-600">Silakan lengkapi formulir di bawah ini untuk membuat perjanjian
                        bersama
                ...
                <form method="POST" action="{{ route('dokumen.perjanjian-bersama.store') }}" class="p-8 space-y-8">
                    ...
                    <!-- Isi Kesepakatan -->
                    <div class="space-y-6">
                        <h3 class="text-lg font-semibold text-gray-800 pb-3 border-b-2 border-gray-200">Isi Kesepakatan
                        </h3>
                        <div class="space-y-2">
                            <label class="flex items-center text-sm font-medium text-gray-700">
                                Detail Kesepakatan
