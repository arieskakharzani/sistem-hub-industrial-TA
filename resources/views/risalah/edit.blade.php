<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Edit Risalah ' . ucfirst($jenis_risalah)) }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-8 py-6 border-b border-gray-200">
                    <h2 class="text-xl font-semibold text-gray-800 mb-2">Form Edit Risalah {{ ucfirst($jenis_risalah) }}
                    </h2>
                    <p class="text-sm text-gray-600">Silakan edit formulir di bawah ini untuk mengubah risalah
                        {{ $jenis_risalah }}</p>
                </div>
                ...
                <form method="POST" action="{{ $updateUrl }}" class="p-8 space-y-8">
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <input type="text" name="nama_perusahaan"
                                    value="{{ old('nama_perusahaan', $risalah->nama_perusahaan) }}"
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="jenis_usaha"
                                    value="{{ old('jenis_usaha', $risalah->jenis_usaha) }}"
                            ...
                            <div class="space-y-2 md:col-span-2">
                                ...
                                <input type="text" name="alamat_perusahaan"
                                    value="{{ old('alamat_perusahaan', $risalah->alamat_perusahaan) }}"
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="tempat_perundingan"
                                    value="{{ old('tempat_perundingan', $risalah->tempat_perundingan) }}"
                                    placeholder="Masukkan tempat perundingan" required
                                    class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-primary focus:ring-4 focus:ring-primary focus:ring-opacity-10 transition-all duration-300">
                            </div>
                            ...
                            <div class="space-y-2 md:col-span-2">
                                ...
                                <textarea name="pokok_masalah" rows="4" required
                                    ...
                                    class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-primary focus:ring-4 focus:ring-primary focus:ring-opacity-10 transition-all duration-300 resize-vertical">{{ old('pokok_masalah', $risalah->pokok_masalah) }}</textarea>
                            </div>
                            ...
                            <div class="space-y-2 md:col-span-2">
                                ...
                                <textarea name="pendapat_pekerja" rows="4" required placeholder="Tuliskan pendapat dari pihak pekerja"
                                    class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-primary focus:ring-4 focus:ring-primary focus:ring-opacity-10 transition-all duration-300 resize-vertical">{{ old('pendapat_pekerja', $risalah->pendapat_pekerja) }}</textarea>
                            </div>
                            ...
                            <div class="space-y-2 md:col-span-2">
                                ...
                                <textarea name="pendapat_pengusaha" rows="4" required placeholder="Tuliskan pendapat dari pihak pengusaha"
                                    class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-primary focus:ring-4 focus:ring-primary focus:ring-opacity-10 transition-all duration-300 resize-vertical">{{ old('pendapat_pengusaha', $risalah->pendapat_pengusaha) }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Kesimpulan -->
                    <div class="space-y-6">
                        <h3 class="text-lg font-semibold text-gray-800 pb-3 border-b-2 border-gray-200">Kesimpulan</h3>
                        <div class="space-y-6">
                            @if ($jenis_risalah === 'klarifikasi')
                                <div class="space-y-2">
                                    ...
                                    <textarea name="arahan_mediator" rows="4" required placeholder="Tuliskan arahan dari mediator"
                                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-primary focus:ring-4 focus:ring-primary focus:ring-opacity-10 transition-all duration-300 resize-vertical">{{ old('arahan_mediator', $detail->arahan_mediator ?? '') }}</textarea>
                                </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <p class="text-xs text-gray-500 italic">Pilih kesimpulan yang sesuai dengan hasil
                                        klarifikasi</p>
                                </div>
                            @else
                                <div class="space-y-2">
                                    ...
                                    <textarea name="kesimpulan_penyelesaian" rows="6" required
                                        ...
                                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-primary focus:ring-4 focus:ring-primary focus:ring-opacity-10 transition-all duration-300 resize-vertical">{{ old('kesimpulan_penyelesaian', $detail->kesimpulan_penyelesaian ?? '') }}</textarea>
                                    <p class="text-xs text-gray-500 italic">Jelaskan dengan detail hasil perundingan
                                        yang telah
                                        dicapai</p>
                                </div>
                            @endif
                            ...
                            @if ($jenis_risalah === 'mediasi')
                                ...
                                <div class="space-y-2">
                                    ...
                                    <textarea name="ringkasan_pembahasan" rows="4" required placeholder="Tuliskan ringkasan pembahasan mediasi"
                                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-primary focus:ring-4 focus:ring-primary focus:ring-opacity-10 transition-all duration-300 resize-vertical">{{ old('ringkasan_pembahasan', $detail->ringkasan_pembahasan ?? '') }}</textarea>
                                </div>
                                <div class="space-y-2">
                                    <label class="flex items-center text-sm font-medium text-gray-700">
                                    ...
                                    <textarea name="kesepakatan_sementara" rows="3" placeholder="Tuliskan kesepakatan sementara jika ada"
                                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-primary focus:ring-4 focus:ring-primary focus:ring-opacity-10 transition-all duration-300 resize-vertical">{{ old('kesepakatan_sementara', $detail->kesepakatan_sementara ?? '') }}</textarea>
                                </div>
                                <div class="space-y-2">
                                    <label class="flex items-center text-sm font-medium text-gray-700">
                                    ...
                                    <textarea name="ketidaksepakatan_sementara" rows="3" placeholder="Tuliskan ketidaksepakatan sementara jika ada"
                                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-primary focus:ring-4 focus:ring-primary focus:ring-opacity-10 transition-all duration-300 resize-vertical">{{ old('ketidaksepakatan_sementara', $detail->ketidaksepakatan_sementara ?? '') }}</textarea>
                                </div>
                                <div class="space-y-2">
                                    <label class="flex items-center text-sm font-medium text-gray-700">
                                        Catatan Khusus
                                    ...
                                    <textarea name="catatan_khusus" rows="3" placeholder="Catatan khusus untuk mediasi ini"
                                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-primary focus:ring-4 focus:ring-primary focus:ring-opacity-10 transition-all duration-300 resize-vertical">{{ old('catatan_khusus', $detail->catatan_khusus ?? '') }}</textarea>
                                </div>
                                <div class="space-y-2">
                                    <label class="flex items-center text-sm font-medium text-gray-700">
                                    ...
                                    <textarea name="rekomendasi_mediator" rows="3" placeholder="Rekomendasi mediator untuk sidang ini"
                                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-primary focus:ring-4 focus:ring-primary focus:ring-opacity-10 transition-all duration-300 resize-vertical">{{ old('rekomendasi_mediator', $detail->rekomendasi_mediator ?? '') }}</textarea>
                                </div>
                            @endif
                        </div>
                    </div>
